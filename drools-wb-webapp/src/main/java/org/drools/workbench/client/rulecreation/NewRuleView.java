...
package org.drools.workbench.client.rulecreation;
...
@ApplicationScoped
public class NewRuleView extends BaseModal implements NewResourcePresenter.View {

    interface NewRuleViewBinder
            extends
            UiBinder<Widget, NewRuleView> {

    }

    private static NewRuleViewBinder uiBinder = GWT.create( NewRuleViewBinder.class );
    ...
    public NewRuleView() {
        ...
        setBody( uiBinder.createAndBindUi( NewRuleView.this ) );
        add( footer );
    }
